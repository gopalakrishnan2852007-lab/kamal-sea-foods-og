...
export default function Footer() {
  return (
    <footer className="w-full py-16 bg-primary border-t border-[#092c44]">
      <ScrollReveal className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
        <div className="lg:col-span-1">
          ...
          <div className="text-white/80 text-xs leading-relaxed space-y-1 mb-6 border-l-2 border-white/20 pl-3 py-1">
            <p><strong className="text-white">Kamal Sea Food</strong></p>
            <p>Salem, Tamil Nadu</p>
            <p>Phone: +91 9865668125</p>
            <p>Wholesale & Retail Seafood Supplier</p>
          </div>

          <div className="text-white/60 text-[10px] uppercase font-bold tracking-widest flex flex-col gap-1.5 mt-2">
      ...
      <ScrollReveal className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-[#092c44]">
        <h2 className="text-white/60 text-sm font-medium">© 2026 Kamal Sea Food – Frozen Seafood Retail & Wholesale. All
          rights reserved.</h2>
        <p className="text-white/60 text-xs">Kamal Sea Food</p>
      </ScrollReveal>
    </footer>
  );
}
